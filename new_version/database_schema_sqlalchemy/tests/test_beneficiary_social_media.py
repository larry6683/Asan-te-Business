"""
Usage: bash python -m database_schema_sqlalchemy.tests.test_beneficiary_social_media
"""
import uuid
...
from database_schema_sqlalchemy.src.public.tables.beneficiary_social_media import BeneficiarySocialMedia
