"""
Usage: bash python -m database_schema_sqlalchemy.tests.test_business_social_media
"""
import uuid
...
from database_schema_sqlalchemy.src.public.tables.business_social_media import BusinessSocialMedia
