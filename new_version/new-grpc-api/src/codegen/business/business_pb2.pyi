...
class GetBusinessResponse(_message.Message):
    ...
    def __init__(self, business: _Optional[_Union[Business, _Mapping]] = ..., errors: _Optional[_Iterable[_Union[_error_pb2.Error, _Mapping]]] = ...) -> None: ...
...
class Cause(_message.Message):
    ...
    name: str
    rank: str
    def __init__(self, name: _Optional[str] = ..., rank: _Optional[str] = ...) -> None: ...

class CreateBusinessRequest(_message.Message):
    __slots__ = ("business_name", "email", "website_url", "phone_number", "location_city", "location_state", "ein", "business_description", "business_size", "user_email", "cause_codes")
    BUSINESS_NAME_FIELD_NUMBER: _ClassVar[int]
    EMAIL_FIELD_NUMBER: _ClassVar[int]
    WEBSITE_URL_FIELD_NUMBER: _ClassVar[int]
    PHONE_NUMBER_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, business_name: _Optional[str] = ..., email: _Optional[str] = ..., website_url: _Optional[str] = ..., phone_number: _Optional[str] = ..., location_city: _Optional[str] = ..., location_state: _Optional[str] = ..., ein: _Optional[str] = ..., business_description: _Optional[str] = ..., business_size: _Optional[str] = ..., user_email: _Optional[str] = ..., cause_codes: _Optional[_Iterable[str]] = ...) -> None: ...
