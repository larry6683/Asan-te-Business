"""
Usage: bash python -m database_schema_sqlalchemy.tests.test_business_shop
"""
import uuid
...
from database_schema_sqlalchemy.src.public.tables.business_shop import BusinessShop
