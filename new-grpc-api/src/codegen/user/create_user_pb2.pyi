...
class CreateUserRequest(_message.Message):
    ...
    auth: _auth_pb2.Auth
    user_data: CreateUserRequest.UserData
    def __init__(self, auth: _Optional[_Union[_auth_pb2.Auth, _Mapping]] = ..., user_data: _Optional[_Union[CreateUserRequest.UserData, _Mapping]] = ...) -> None: ...
